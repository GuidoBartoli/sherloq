...
from gui.sherloq_app.paths import GUI_ROOT, TRUFOR_DIR
import os
import sys
...
TRUFOR_WEIGHTS = TRUFOR_DIR / "test_docker" / "weights" / "trufor.pth.tar"
TRUFOR_SOURCE = TRUFOR_DIR / "test_docker" / "src"

if TRUFOR_WEIGHTS.exists():
