...
from PySide6.QtWidgets import QVBoxLayout, QHBoxLayout, QLabel, QSpinBox, QCheckBox, QPushButton
...
class GhostmapWidget(ToolWidget):
    ...
    def processGhostmaps(self):
        ...
        if includeoriginal:
            ...
            original_uint8 = cv2.convertScaleAbs(original) #cv2.cvtColor expects input images to have depth of 8-bit per channel
        ...
        # Add main title
        self.plt.suptitle('Ghost plots for grid offset X = '+ str(shift_x)+" and Y = " + str(shift_y))  
